...
const ContactMe = () => {
  return (
    <div id='contact' className='pt-20'>
      <div className='px-6 md:px-10 py-8 flex flex-col items-start md:items-center justify-between md:flex-row text-white bg-gradient-to-br from-indigo-500 to-violet-500 rounded-lg '>
         ...
         <div className='mt-6'>
            <a className='px-4 py-3 text-black text-sm md:text-base bg-white rounded-lg'>ContactMe</a>
         </div>
      </div>
    </div>
  )
