            ...
            <div className='flex flex-col items-center md:flex-row-reverse'>
                <div className='md:ml-8'>
                    ...
                    <div className='mt-7 mb-14'>
                        <a href="/contact" className='px-4 py-3 mr-2 font-semibold bg-indigo-500 text-white shadow-lg shadow-indigo-400 rounded-md text-sm hover:bg-indigo-800 hover:shadow-indigo-500 transition duration-300'>Contact Me</a>
